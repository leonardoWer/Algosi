...
class TaskTest6(unittest.TestCase):
    ...
    def test_sort(self):
        ...
        # then
        self.assertEqual(bubble_sort(n, lst), [26, 31, 41, 41, 58, 59])
    ...
    def test_sort_hard(self):
        ...
        # then
        self.assertEqual(bubble_sort(n_hud, lst_hud), sorted(lst_hud))
    ...
    def test_sort_middle(self):
        ...
        # then
        self.assertEqual(bubble_sort(n_sr, lst_sr), sorted(lst_sr))

    def test_hard_insertion_vs_bubble_sort(self):
        # given
        lst_hud = [random.randint(1, 100_000) for i in range(6_000)]
        n_hud = 6_000
