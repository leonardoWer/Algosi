from lab1.task3.src.task3 import reverse_insertion_sort
import datetime
import tracemalloc
...
class TaskTest3(unittest.TestCase):
    ...
    def test_sort(self):
        ...
        print(reverse_insertion_sort(n, lst))
        ...
        # then
        self.assertEqual(reverse_insertion_sort(n, lst), [59, 58, 41, 41, 31, 26])
